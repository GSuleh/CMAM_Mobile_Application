...
public class ResourceAdapterForHealthFacilityAllocation extends RecyclerView.Adapter {

    List<ResourceClass> resources_list;
    Context context;

    public ResourceAdapterForHealthFacilityAllocation(Context context, List<ResourceClass> resources_list) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        myholder.parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, MapHealthFacilityAllocateResources.class);
