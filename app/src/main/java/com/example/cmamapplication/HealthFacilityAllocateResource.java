...
public class HealthFacilityAllocateResource extends AppCompatActivity {
    ...
    ResourceAdapterForHealthFacilityAllocation adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_health_facility_allocate_resource);

        recyclerview = (RecyclerView) findViewById(R.id.healthfacility_allocate_recyclerview);
                ...
                if (admin != null) {
                    ...
                    reference1.orderByChild("committee_id").equalTo(committee).addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            adapter = new ResourceAdapterForHealthFacilityAllocation(HealthFacilityAllocateResource.this, resourceData);
