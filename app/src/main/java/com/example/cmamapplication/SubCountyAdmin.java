...
public class SubCountyAdmin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(SubCountyAdmin.this, "Something went wrong!", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.resourcecard:
                startActivity(new Intent(this, subcountyresources.class));
                break;
