...
public class linkfacilityresources extends AppCompatActivity implements View.OnClickListener {
    private CardView request, allocate;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_linkfacilityresources);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.assignresourcecard:
                startActivity(new Intent(this, HealthFacilityAllocateResource.class));
                break;
